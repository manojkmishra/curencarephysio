...
--------------------------------------------------------------*/
.cta {
  background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url("../assets/img/slide/fire2.jpg") fixed center center;
  background-size: cover;
  padding: 120px 0;
}
.security {
  background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url("../assets/img/slide/security3.png") fixed center center;
  background-size: cover;
  padding: 120px 0;
}
.manpower {
  background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url("../assets/img/slide/manpower4.jpg") fixed center center;
  background-size: cover;
  padding: 120px 0;
}
